...
When you use the hosted API at `https://api.smart402.com`:
...
**Email: security@smart402.com**, or use this repository's [private vulnerability reporting](https://github.com/Falinkaz/smart402-js/security/advisories/new) (Security → Report a vulnerability). Either reaches us; pick whichever you already have open.
